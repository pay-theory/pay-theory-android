package com.paytheory.lib.watchers//package com.paytheory.lib.watchers
//
...
// */
//private fun areFieldsValid(viewModel: PaymentViewModel): Boolean {
//    return (isAddressValid(viewModel) == true && checkPaymentFieldValidity(viewModel) == true)
//}
//
//fun checkPaymentFieldValidity(viewModel: PaymentViewModel): Boolean {
//    return isCardValid(viewModel) && isBankValid(viewModel) && isBankValid(viewModel)
//}
//
///**
// * Function that checks the validity of all bank fields and enables/disables the pay button
...
// */
//fun isAddressValid(viewModel: PaymentViewModel): Boolean{
//    if (viewModel.requiresAddress() == false) {
//        if (viewModel.chosenPaymentMethod() == PaymentMethodType.CARD) {
//            return isZipCodeValid(viewModel)
//        }
//        return true
//    }
//    //check if all card fields are valid
//    return isAddressLineValid(viewModel) && isCityValid(viewModel) && isRegionValid(viewModel) && isZipCodeValid(viewModel)
//}
//
///**
...
// */
//class AddressLine1TextWatcher(viewModel: PaymentViewModel) :
//    TextWatcher {
