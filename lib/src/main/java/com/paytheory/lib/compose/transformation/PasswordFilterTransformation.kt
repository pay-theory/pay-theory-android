...
/**
 * [VisualTransformation] that masks the input text with asterisks (*), effectively hiding the original
 ...
 * "password", it will be after the 3rd asterisk in the transformed text "********".
 */
