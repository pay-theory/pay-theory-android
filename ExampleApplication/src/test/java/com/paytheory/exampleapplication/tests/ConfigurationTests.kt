...
//        requireAddress, TransactionType.CASH, FeeMode.SERVICE_FEE)
//
//    /**
...
//                && !configData.requireAddress && configData.transactionType == TransactionType.CASH && configData.feeMode == feeMode)
//    }
//
//    /**
...
//            requireAddress, TransactionType.CARD, FeeMode.SURCHARGE))
//
